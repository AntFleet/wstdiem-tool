...
1. Base mainnet addresses for `InferenceVault`/wstDIEM, `FeeRouter`, `AgentTGERegistry`, Router/`loopExecutor`, Curve DIEM/wstDIEM, Morpho oracle, and Morpho market id are now pinned to the v6 redeploy (live 2026-06-10; v5 superseded — see `docs/research/liquid-protocol-v6-launch.md`). The wstDIEM/DIEM leverage-loop market id `0xdd6b9f10bf69445ebba0626ef54042af628cdf65dda98ff68df4d235d4d56c76` resolves to DIEM loan token, wstDIEM (v6) collateral, oracle `0xAF29776f93FE0bf21282bF792A52AC212f20F45c` (vault NAV), adaptive Curve IRM, and `86e16` LLTV. Live reads on 2026-06-12 show ~23 DIEM vault assets, 18.7/18.7 symmetric Curve depth, and 0 DIEM loan-side liquidity on Morpho, so the loop remains blocked on Morpho DIEM supply and a funded/authorized owner position. The internal v6 security review remains non-third-party-audited and one HIGH (MOG-541) is risk-accepted on the fee path; production audit gate is unchanged.
